...
description: Official GSAP skill for Vue, Nuxt, Svelte, and other component frameworks — lifecycle hooks, gsap.context(), cleanup. Use when writing GSAP in Vue (or Nuxt), Svelte (or SvelteKit), or other non-React component frameworks. For React/Next.js use gsap-react instead.
license: MIT
---
