    ...
    <section ref={sectionRef} className="py-20 overflow-hidden relative">
      ...
      <div className="relative max-w-6xl mx-auto px-6 flex flex-col items-center text-center gap-6">
        ...
        <div className="flex items-center">
          <a data-cta-btn href="https://app.lori-talk.eu/register" className="px-8 py-3.5 rounded-full font-semibold text-sm bg-white hover:bg-white/90 transition-colors" style={{ color: "#94BF5C", visibility: "hidden" }}>{t("ctaBanner.ctaPrimary")}</a>
        </div>
      </div>
    </section>
  );
