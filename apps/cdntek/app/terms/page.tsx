...
export const metadata: Metadata = {
  ...
  description:
    "Termos de serviço da CDNTEK. Condições de utilização do nosso website e dos nossos serviços de tecnologia.",
        ...
        <div className="max-w-4xl mx-auto space-y-10 text-gray-300 leading-relaxed">
          <div className="space-y-2 text-center md:text-left">
            ...
            <h1 className="text-3xl md:text-4xl font-semibold">
              A usar a nossa tecnologia de forma respons&#225;vel
            </h1>
