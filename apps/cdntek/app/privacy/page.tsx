...
export const metadata: Metadata = {
  ...
  description:
    "Política de privacidade da CDNTEK. Saiba como recolhemos, utilizamos e protegemos os seus dados pessoais em conformidade com o RGPD.",
  ...
  },
  {
    ...
    content: (
      <div>
        ...
        <p>
          Parkurbis - Parque da Ci&#234;ncia e Tecnologia da Covilh&#227;
        </p>
  ...
  },
  {
    ...
    content: (
      <div>
        ...
        <p>Email: infglobal@cdncore.eu</p>
        <p>
          Address: Parkurbis - Parque da Ci&#234;ncia e Tecnologia da
          Covilh&#227;, 6200-865 Covilh&#227;, Portugal
        </p>
      </div>
    ),
  },
        ...
        <div className="max-w-4xl mx-auto space-y-10 text-gray-300 leading-relaxed">
          <div className="space-y-2 text-center md:text-left">
            ...
            <h1 className="text-3xl md:text-4xl font-semibold">
              A proteger os seus dados com transpar&#234;ncia
            </h1>
            <p className="text-sm text-white/50">
              &#218;ltima actualiza&#231;&#227;o: 28 de Novembro de 2025
            </p>
          </div>
