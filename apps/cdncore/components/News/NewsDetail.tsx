...
export function NewsDetail({ article }: { article: NewsArticle }) {
    return (
        <div style={{ minHeight: '100vh', backgroundColor: '#0c0c14' }}>
            <style dangerouslySetInnerHTML={{ __html: detailGridCSS }} />
            {/* Ambient background */}
            <div style={{ position: 'fixed', inset: 0, overflow: 'hidden', pointerEvents: 'none' }}>
                <div style={{ position: 'absolute', top: 0, left: '25%', width: '500px', height: '500px', background: 'rgba(147,51,234,0.03)', borderRadius: '50%', filter: 'blur(150px)' }} />
                <div style={{ position: 'absolute', top: '33%', right: '25%', width: '600px', height: '600px', background: 'rgba(59,130,246,0.03)', borderRadius: '50%', filter: 'blur(150px)' }} />
            </div>
            ...
            <div style={{ position: 'relative', width: '100%', height: '55vh', minHeight: '360px', overflow: 'hidden' }}>
                ...
                />
                <div style={{ position: 'absolute', inset: 0, background: 'linear-gradient(to bottom, rgba(0,0,0,0.3), rgba(0,0,0,0.1) 50%, #0c0c14)' }} />
            </div>
            ...
            <div style={{ position: 'relative', zIndex: 10, maxWidth: '1280px', margin: '0 auto', padding: '0 2rem', marginTop: '-7rem' }}>
                <div className="detail-grid">
                    ...
                    {/* Main article */}
                    <article style={{ background: '#13131a', border: '1px solid rgba(255,255,255,0.06)', borderRadius: '0.75rem', padding: 'clamp(2rem, 4vw, 3rem)' }}>
                        {/* Meta */}
                        ...
                        <div style={{ paddingTop: '2rem', borderTop: '1px solid rgba(255,255,255,0.06)' }}>
                            <Link
                                href="/news"
                                style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', color: '#c084fc', textDecoration: 'none', fontSize: '0.875rem', fontWeight: 500 }}
                            >
                    ...
                    <aside className="detail-sidebar">
                        {/* Tags */}
                        <div style={{ background: '#13131a', border: '1px solid rgba(255,255,255,0.06)', borderRadius: '0.75rem', padding: '1.5rem', marginBottom: '1.5rem' }}>
                            ...
                            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.5rem' }}>
                                {(article.tags.length > 0 ? article.tags : ["AI", "Cybersecurity", "Technology", "Innovation", "Enterprise"]).map(tag => (
                                    <span
                                        key={tag}
                                        style={{
