...
export function NewsSection({ articles }: { articles: NewsArticle[] }) {
    ...
    return (
        <div style={{ backgroundColor: '#000', minHeight: '100vh' }}>
                ...
                >
                    ...
                    <div
                        style={{
                            position: 'absolute',
                            inset: 0,
                            background: 'linear-gradient(to top, #000, rgba(0,0,0,0.6) 50%, transparent)',
                        }}
                    />
                    <div
                        style={{
            ...
            {/* DIVIDER - orange/pink gradient */}
            <div style={{ padding: '0 2rem' }}>
                <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
                    <div style={{ height: '1px', background: 'linear-gradient(to right, transparent, rgba(242, 142, 18, 0.3), rgba(218, 29, 93, 0.3), transparent)' }} />
                </div>
            </div>
