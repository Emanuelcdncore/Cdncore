...
const AboutSection = () => {
    ...
    const historyData: HistoryItem[] = [
        {
            year: "2009",
            title: "The Beginning",
            description: "Founded in Lisbon with the mission of crafting meaningful audiovisual stories, the company has grown and evolved over time. Today, while our origins remain in Lisbon, our creative base operates from Covilha, where we continue to develop our work."
        },
        {
            year: "2015",
    ...
    const coreValues = [
        ...
        { title: "PUNCTUALITY", description: "" },
        { title: "CONFIDENTIALITY", description: "" }
    ];
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
                        ...
                        >
                            <p className="text-lg text-gray-300 leading-relaxed text-left md:text-right">
                                Located in the heart of Covilha and expanding its expertise globally, CDNTV stands as a beacon of excellence in audiovisual production.
                            </p>
                        </motion.div>
                    </div>
                ...
                <div className="container mx-auto px-6">
                    ...
                    >
                        <h2
                            ...
                            style={{ fontSize: '40px', lineHeight: '100%', fontWeight: 700 }}
                        >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 items-end mb-12">
                        ...
                        <div className="flex flex-col items-center">
                            <div className="w-12 h-12 mb-6 flex items-center justify-center">
                                <div style={{ width: '32px', height: '32px', background: 'linear-gradient(135deg, #F28E12 0%, #E9408A 100%)', transform: 'rotate(45deg)' }} />
                            </div>
                        ...
                        <div className="flex flex-col items-center">
                            <div className="w-12 h-12 mb-6 flex items-center justify-center">
                                <div style={{ width: '32px', height: '32px', background: 'linear-gradient(135deg, #F28E12 0%, #E9408A 100%)' }} />
                            </div>
                        ...
                        <div className="flex flex-col items-center">
                            <div className="w-12 h-12 mb-6 flex items-center justify-center">
                                <div style={{ width: '32px', height: '32px', borderRadius: '50%', background: 'linear-gradient(135deg, #F28E12 0%, #E9408A 100%)' }} />
                            </div>
                    ...
                    <div className="flex items-center justify-center">
                        <div style={{ width: '100%', height: '600px', position: 'relative' }}>
                            <div style={{ position: 'absolute', inset: 0, zIndex: 1 }}>
                                <Orb hue={235} hoverIntensity={0} rotateOnHover={false} forceHoverState={false} />
                            </div>
                            <div className="absolute inset-0 flex flex-col items-center justify-center text-center" style={{ zIndex: 2 }}>
                                <motion.h2 className="text-4xl md:text-5xl font-bold text-white mb-4" initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} viewport={{ once: true }}>
                                    Ready to Create?
                                </motion.h2>
                                <motion.p className="text-lg text-white/80 mb-6" initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.2 }} viewport={{ once: true }}>
                                    Let&apos;s bring your vision to life.
                                </motion.p>
                                <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.4 }} viewport={{ once: true }}>
                                    <Button size="lg" asChild className="bg-white text-black hover:bg-white/90 px-6 py-3 text-base font-semibold rounded-lg">
