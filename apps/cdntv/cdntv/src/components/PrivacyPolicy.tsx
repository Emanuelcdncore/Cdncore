      ...
      <div className="legal-container">
        ...
        <div className="legal-content">
          <section>
            ...
            <p>
              CDNCORE is committed to protecting your privacy. 
              This Privacy Policy explains how we collect, use, disclose and protect 
              your information when you use our website (cdncore.pt) and our 
          ...
          <section>
            ...
            <ul>
              ...
              <li><strong>Professional data:</strong> role, area of interest in AI and drones</li>
            </ul>
          ...
          <section>
            ...
            <p className="contact-rights">
              To exercise your rights, contact us at: <strong>infglobal@cdncore.eu</strong>
            </p>
          </section>
          ...
          <section>
            ...
            <div className="contact-info">
              ...
              <p><strong>Address:</strong> Parkurbis, 6200-865 Covilhã</p>
            </div>
