...
const AboutSection = () => {
    ...
    const recenterMap = () => {
        setMapZoom((prevZoom) => {
            ...
            if (mapIframeRef.current) {
                mapIframeRef.current.src = buildMapSrc(targetZoom);
            }
        ...
        <>
            ...
            <section className="bg-black">
                <div className="container mx-auto px-6 py-8">
                    ...
                    {/* Map Section */}
                    <div className="w-full max-w-7xl mx-auto mt-2 mb-6 px-5 lg:px-20 pt-2 flex justify-center items-center">
                        <div className="relative w-full overflow-hidden bg-transparent">
                            ...
                            {/* Pin Simples da Localização (alinhado ao ponto exato do mapa) */}
                    ...
                    {/* Logo section */}
                    <div className="text-center flex justify-center items-center mb-8 min-h-[120px]">
                        <Image
