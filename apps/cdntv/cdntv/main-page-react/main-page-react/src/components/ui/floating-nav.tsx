...
export const FloatingNav = ({
    ...
    useMotionValueEvent(scrollYProgress, "change", (current) => {
        if (typeof current === "number") {
            ...
            // Detecta movimento real de scroll
            if (Math.abs(now - lastScroll) > 0.003) {
                setScrolling(true);
            } else {
                setScrolling(false);
                        ...
                        >
                            <div className="flex items-center justify-between p-4">
                                ...
                                <div className="flex items-center h-10">
                                    <img src="/3.png" alt="CDNTV" className="w-10 h-8 object-contain ml-2 rounded shadow-lg" style={{ minHeight: '32px' }} />
                                </div>
                            </div>
            ...
            >
                ...
                <div className="flex items-center relative z-10">
                    <Link href="/" className="flex items-center">
                        <Image src="/3.png" alt="CDNTV" width={30} height={20} className="object-contain" />
                    </Link>
                </div>
